package EX4;
    public class Etagere {
        ...
        Etagere(int etMax, Livre[] livres) {
            this.etMax = etMax;
            this.nbl = livres.length;
            this.livres = new Livre[etMax];
        ...
        public void supprimer(Livre livre) {
            ...
            for (int i = j; i < nbl - 1; i++) livres[i] = livres[i + 1];
            nbl--;
        }
        @Override
        public String toString(){
            StringBuilder s = new StringBuilder("L'etage contient " + nbl + "/" + etMax + ":\n");
            for(int i = 0; i < nbl; i++){
